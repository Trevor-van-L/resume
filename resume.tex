...
\jobtitle{Qualcomm}{Engineer}{C, C++, C\#, python}{April 2019 -- Present}
\begin{itemize}
    \item{Developed audio management layer which controls life-cycle of all audio use-cases on DSP. Interfaces between main processor to DSP for all DSPs and all OSs supported by Qualcomm, as part of larger audio redesign. Commercialized on Snapdragon 898}
    \item{Migrated management layer to internal open-source product. Mentored \& empowered other engineers to contribute}
    \item {Built performant management system for ad-hoc data memory allocation as part of Android Codec 2.0. Prior system required data memory allocation at use-case setup}
...
\comment{\item{TODO: ACD. Impact statements. Name GSL? More on what GSL does? Double indented list?}
}
\end{itemize}
\bigskip
...
\shorttitle{Shopify}{Full Stack Developer}{Ruby on Rails, MySQL}{Jan -- Apr 2016}
\comment{
\begin{itemize}
...
\shorttitle{TD Canada Trust}{Android Developer}{Java, AngularJS}{May -- Aug 2015}
\comment{
\begin{itemize}
...
\shorttitle{Nanometrics}{Firmware Developer}{C++, bash}{Sept -- Dec 2014}
\comment{
\begin{itemize}
...
\shorttitle{Recognia}{Backend Developer}{Java, Perl, PostgreSQL, AngularJS}{Jan -- Apr 2014}
\comment{
{\footnotesize
 \hfill Jan  -- Apr 2014\\
}
