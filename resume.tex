...
\jobtitle{Qualcomm}{Audio Framework Engineer}{C, C++, C\#, python}{April 2019 -- Present}
\begin{itemize}
    \item{GSL
  \comment{ \item {Developed an IPC layer which supports real-time voice \& audio communicaton across DSP, modem and Application processors on Snapdragon SoC. }}
    \item {TODO: Codec 2.0?}
    \item {Created debugging tool to parse binary packet log dumps into human-readable}
    \item {TODO: Intern mentorships}
    \item {TODO:}
\end{itemize}
\bigskip
...
\jobtitle{Shopify}{Full Stack Developer}{Ruby on Rails, MySQL}{Jan -- Apr 2016}
\begin{itemize}
