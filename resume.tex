...
\jobtitle{Qualcomm}{Engineer, Audio Software}{C, C++, C\#, python}{April 2019 -- Present}
\smallskip
\\
...
\begin{itemize}
    ...
    \item {Designed \& built memory management system for ad-hoc data memory allocation as part of Android Codec 2.0. Prior system required data memory allocation at use-case setup} \comment{link https://ignitarium.com/android-codec-2-0-developing-multimedia-applications-for-newer-android-platforms/}
    \item{Migrated common driver to internal open-source product. Mentored \& empowered other engineers to contribute and debug}
\end{itemize}

\textbf{Open Source Framework}
\\
Released AudioReach framework as open source project
\begin{itemize}
	\item{Adapted Android code into generic linux base}
\end{itemize}
